...
class GraphData(models.Model):
    ...
    WindSpeed = models.CharField(max_length=25, blank=True, null=True)
    Humidity = models.CharField(max_length=25, blank=True, null=True)
    Precipitation = models.CharField(max_length=25, blank=True, null=True)
